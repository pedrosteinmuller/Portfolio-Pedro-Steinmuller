...
const myProjects = [
  {
    nome: 'Lessons Learned',
    descricao: 'No meu primeiro projeto na Trybe, fui capaz de desenvolver um site que contenha uma série de informações sobre o que eu aprendi ao longo dos últimos três blocos. O meu primeiro site contém os elementos posicionados e estilizados e, além disso, contem semântica apropriada para que seja acessível e melhor ranqueado.',
    link: 'https://projeto-lessons-learned.vercel.app/',
    github: 'https://github.com/pedrosteinmuller/ProjetoLessonsLearned',
    stacks: [html, css, git, github],
  },
  {
